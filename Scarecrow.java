...
class Scarecrow {
     ...
     */
    public Scarecrow(Pumpkin h, Shirt s, Pants p, Boot l, Boot r, Banner m) {
        head = h;
        body = s;
        legs = p;
        leftFoot = l;
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        Scarecrow myScarecrow = new Scarecrow(new Pumpkin(), new Shirt(), new Pants(), new Boot ("left"), new Boot("right"), new Banner("I'm not a train"));
